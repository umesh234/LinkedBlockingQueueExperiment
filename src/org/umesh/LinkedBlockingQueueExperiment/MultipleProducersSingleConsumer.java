...
//Same number of producer and consumer threads : Time increases from 2 seconds to 3.4 seconds when threads increase from 1 to 100
	...
	public static void main(String args[]) throws InterruptedException {
		...
		for( int THREAD_COUNT =5 ; THREAD_COUNT < 100 ; THREAD_COUNT += 10) {
			...
			for( int i=0;i<trials ;i++) {
				int pmsgs = MAX/THREAD_COUNT;
				duration +=runTest(THREAD_COUNT , pmsgs, THREAD_COUNT*pmsgs);
			}
